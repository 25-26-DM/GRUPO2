package ec.edu.uce.rec_amelizalde
...
import ec.edu.uce.rec_amelizalde.ui.theme.RECAMELIZALDETheme
import ec.edu.uce.rec_amelizalde.ui.LoginScreen
import ec.edu.uce.rec_amelizalde.ui.RegisterScreen
import ec.edu.uce.rec_amelizalde.ui.ProductsListScreen
import ec.edu.uce.rec_amelizalde.ui.ProductFormScreen
import ec.edu.uce.rec_amelizalde.data.Product
import ec.edu.uce.rec_amelizalde.data.AppDatabase
import ec.edu.uce.rec_amelizalde.session.SessionManager
import ec.edu.uce.rec_amelizalde.sync.DynamoDBHelper
import ec.edu.uce.rec_amelizalde.sync.SyncScheduler
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) @androidx.annotation.RequiresPermission(android.Manifest.permission.ACCESS_NETWORK_STATE) {
