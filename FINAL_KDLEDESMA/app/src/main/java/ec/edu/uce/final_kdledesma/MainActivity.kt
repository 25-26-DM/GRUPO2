package ec.edu.uce.final_kdledesma
...
import ec.edu.uce.final_kdledesma.ui.theme.FINAL_KDLEDESMATheme
import ec.edu.uce.final_kdledesma.ui.LoginScreen
import ec.edu.uce.final_kdledesma.ui.RegisterScreen
import ec.edu.uce.final_kdledesma.ui.ProductsListScreen
import ec.edu.uce.final_kdledesma.ui.ProductFormScreen
import ec.edu.uce.final_kdledesma.data.Product
import ec.edu.uce.final_kdledesma.data.AppDatabase
import ec.edu.uce.final_kdledesma.session.SessionManager
import ec.edu.uce.final_kdledesma.sync.DynamoDBHelper
import ec.edu.uce.final_kdledesma.sync.SyncScheduler
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            if (hasWifi && hasInternet) {
                val workRequest = androidx.work.OneTimeWorkRequestBuilder<ec.edu.uce.final_kdledesma.sync.SyncWorker>().build()
