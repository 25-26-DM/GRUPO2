...
fun DiceWithButtonAndImage(modifier: Modifier = Modifier) {
    ...
    // Usamos stringResource para obtener el texto traducido
    ...
    Column(
        ...
        // Usamos stringResource con formato para "Resultado: UNO"
        Text(
            text = stringResource(R.string.result_label, resultText),
            modifier = Modifier
                .border(
                    width = 2.dp,
                    color = Color.Black,
