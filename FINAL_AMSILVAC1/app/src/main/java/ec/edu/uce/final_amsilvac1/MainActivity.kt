package ec.edu.uce.final_amsilvac1
...
import ec.edu.uce.final_amsilvac1.ui.theme.FINAL_AMSILVAC1Theme
import ec.edu.uce.final_amsilvac1.ui.LoginScreen
import ec.edu.uce.final_amsilvac1.ui.RegisterScreen
import ec.edu.uce.final_amsilvac1.ui.ProductsListScreen
import ec.edu.uce.final_amsilvac1.data.Product
import ec.edu.uce.final_amsilvac1.data.AppDatabase
import ec.edu.uce.final_amsilvac1.session.SessionManager
import ec.edu.uce.final_amsilvac1.sync.DynamoDBHelper
import ec.edu.uce.final_amsilvac1.sync.SyncScheduler
import ec.edu.uce.final_amsilvac1.ui.ProductFormScreen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            if (hasWifi && hasInternet) {
                val workRequest = androidx.work.OneTimeWorkRequestBuilder<ec.edu.uce.final_amsilvac1.sync.SyncWorker>().build()
