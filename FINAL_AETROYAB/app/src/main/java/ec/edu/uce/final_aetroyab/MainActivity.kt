package ec.edu.uce.final_aetroyab
...
import ec.edu.uce.final_aetroyab.ui.theme.FINAL_AETROYABTheme
import ec.edu.uce.final_aetroyab.ui.LoginScreen
import ec.edu.uce.final_aetroyab.ui.RegisterScreen
import ec.edu.uce.final_aetroyab.ui.ProductsListScreen
import ec.edu.uce.final_aetroyab.ui.ProductFormScreen
import ec.edu.uce.final_aetroyab.data.Product
import ec.edu.uce.final_aetroyab.data.AppDatabase
import ec.edu.uce.final_aetroyab.session.SessionManager
import ec.edu.uce.final_aetroyab.sync.DynamoDBHelper
import ec.edu.uce.final_aetroyab.sync.SyncScheduler
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            if (hasWifi && hasInternet) {
                val workRequest = androidx.work.OneTimeWorkRequestBuilder<ec.edu.uce.final_aetroyab.sync.SyncWorker>().build()
