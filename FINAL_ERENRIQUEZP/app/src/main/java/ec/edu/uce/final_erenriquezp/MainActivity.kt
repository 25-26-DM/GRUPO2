package ec.edu.uce.final_erenriquezp
...
import ec.edu.uce.final_erenriquezp.ui.theme.FINAL_ERENRIQUEZPTheme
import ec.edu.uce.final_erenriquezp.ui.LoginScreen
import ec.edu.uce.final_erenriquezp.ui.RegisterScreen
import ec.edu.uce.final_erenriquezp.ui.ProductsListScreen
import ec.edu.uce.final_erenriquezp.ui.ProductFormScreen
import ec.edu.uce.final_erenriquezp.data.Product
import ec.edu.uce.final_erenriquezp.data.AppDatabase
import ec.edu.uce.final_erenriquezp.session.SessionManager
import ec.edu.uce.final_erenriquezp.sync.DynamoDBHelper
import ec.edu.uce.final_erenriquezp.sync.SyncScheduler
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            if (hasWifi && hasInternet) {
                val workRequest = androidx.work.OneTimeWorkRequestBuilder<ec.edu.uce.final_erenriquezp.sync.SyncWorker>().build()
